...
$sql = "select ST_AsGeoJSON(ST_Transform(geom,4326)) as geojson, ntrnombre, (MIN(round(cast(distance as numeric),2))) dist_min
...
select ntrnombre, distance, geom from index_query ) as res
group by ntrnombre, geojson order by dist_min limit 10";
